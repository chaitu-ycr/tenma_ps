"""
Interface for interacting with a Tenma power supply device.

This module provides the [`TenmaPs`](src/tenma_ps/power_supply.py) class to manage device connection, retrieve status, and control voltage/current.
"""
